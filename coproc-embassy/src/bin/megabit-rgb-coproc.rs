...
async fn main(_spawner: embassy_executor::Spawner) {
    ...
    let (mut usb, cdc_acm) = init_usb_device(usb_driver);
    ...
    let r1 = Output::new(nrf_peripherals.P1_08, Level::Low, OutputDrive::Standard);
    let g1 = Output::new(nrf_peripherals.P1_01, Level::Low, OutputDrive::Standard);
    let r2 = Output::new(nrf_peripherals.P1_02, Level::Low, OutputDrive::Standard);
    let g2 = Output::new(nrf_peripherals.P0_27, Level::Low, OutputDrive::Standard);
    let a = Output::new(nrf_peripherals.P0_21, Level::Low, OutputDrive::Standard);
    let c = Output::new(nrf_peripherals.P0_23, Level::Low, OutputDrive::Standard);
    let clk = Output::new(nrf_peripherals.P1_14, Level::Low, OutputDrive::Standard);
    let oe = Output::new(nrf_peripherals.P1_13, Level::High, OutputDrive::Standard);

    let b1 = Output::new(nrf_peripherals.P0_31, Level::Low, OutputDrive::Standard);
    let b2 = Output::new(nrf_peripherals.P0_29, Level::Low, OutputDrive::Standard);
    let b = Output::new(nrf_peripherals.P0_30, Level::Low, OutputDrive::Standard);
    let d = Output::new(nrf_peripherals.P0_05, Level::Low, OutputDrive::Standard);
    let lat = Output::new(nrf_peripherals.P0_04, Level::Low, OutputDrive::Standard);
    ...
    let led_pin = Output::new(nrf_peripherals.P0_13, Level::Low, OutputDrive::Standard);
    let button_pin = UserButton::new(nrf_peripherals.P0_03);
    ...
    let debug_pin = Output::new(nrf_peripherals.P0_02, Level::Low, OutputDrive::Standard);
    let mut debug_2 = Output::new(nrf_peripherals.P0_28, Level::Low, OutputDrive::Standard);
    ...
    embassy_futures::join::join5(
        ...
        async {
            loop {
                ...
                waveshare.render(&mut debug_2).await;
            }
        },
    )
    .await;
