...
SECTIONS {
    ...
    /* Position the start of the application */
    . = __app_flash_origin;

    /* ## Sections in FLASH_APP */
    .image_header : {
        KEEP(*(.image_header))
    } > FLASH_APP
    ...
    * output region or load region in those user sections! */
    ...
    /* Note that this pads the FLASH_APP usage to 32 byte alignment. */
...
/* # Alignment checks */
ASSERT(__app_flash_origin % 4 == 0, "
ERROR: the start of the app flash region must be 4-byte aligned");
...
ASSERT(_stext > __app_flash_origin && _stext < __app_flash_origin + __app_flash_length, "
ERROR: The .text section must be placed inside the application memory.
Set _stext to an address within the application region.");
